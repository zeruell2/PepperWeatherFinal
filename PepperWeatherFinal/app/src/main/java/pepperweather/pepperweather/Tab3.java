...
public class Tab3 extends TabFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        updateWeatherData(CityPreference.instance.getCity());

    }
    //Calls the JSON url for data
    ...
    //Fills the fragment_weather xml fields with json data
    private void renderWeather(JSONObject json){
        try {
            ...
            ((MainActivity) getActivity())
                    .setActionBarTitle(json.getString("name").toUpperCase(Locale.US) +
                            ", " +
                            json.getJSONObject("sys").getString("country"));
